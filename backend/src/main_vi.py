...
from src.routers import services_routers_vi
# from src.routers.authorization import authenticate
...
app.include_router(services_routers_vi.router, prefix="", tags=["ntq_services"])

def main():
    uvicorn.run("src.main_vi:app", host="0.0.0.0", port=6061)
